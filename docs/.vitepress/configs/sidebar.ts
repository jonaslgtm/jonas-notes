...
import { autoGenerateDailyNotes } from '../utils/auto-sidebar'
...
export const sidebar: DefaultTheme.Config['sidebar'] = {
  ...
  //     collapsed: false,
  //     items: [
  //       { text: '测试文件不上传', link: '/daily-notes/2025/a-1' },
  //       { text: '02 月', link: '/daily-notes/2025/a-1-copy.md' },
  //     ]
  //   },
  //   {
  //     text: '2024 年',
  //     collapsed: false,
  //     items: [
  //       { text: '01 月', link: '/daily-notes/2024/01' },
  //       { text: '02 月', link: '/daily-notes/2024/02' },
  //     ]
  //   },
  // ],

// 自动生成 daily-notes 侧边栏
  '/daily-notes/': autoGenerateDailyNotes()
